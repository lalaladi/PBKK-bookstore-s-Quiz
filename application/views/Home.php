...
<div class="main-content">
	...
	<section class="dashboard-counts no-padding-bottom">
	        ...
	        <div class="col-xl-4 col-sm-4">
	          <div class="item d-flex align-items-center">
	            ...
	            <a href="<?php echo base_url('index.php/riwayat') ?>" class="text-secondary">
	              <div class="title"><span>Earnings(in thousand)</span></div>
	            </a>
	            <span class="number"><?php echo 'Rp'.$jml_transaksi->jml_transaksi; ?></span>
	          </div>
	        </div>
	        <!-- Item -->
	        <div class="col-xl-4 col-sm-4">
		...
		<?php } elseif (($this->session->userdata('level') == 'client')) {?>
			<section class="dashboard-counts no-padding-bottom">
			<div class="container-fluid">
			<div class="row bg-white has-shadow">
				<!-- Item -->
